...
export async function getServerSideProps(context) {
    ...
    const blogs = await axios.get(`${process.env.NEXT_PUBLIC_SERVER_URL}/blogs?page=${page ? page : 1}`)
...
const Blogs = (props) => {
    ...
    const handlePagination = async (page) => {
        await router.replace(`${process.env.NEXT_PUBLIC_CLIENT_URL}/blog?page=${page}`)
    ...
    return (<>
        ...
        <div>
            ...
            <div className={'px-8 lg:px-0'}>
                ...
                <section>
                    <Pagination currentPage={currentPage} setCurrentPage={setCurrentPage} postsPerPage={postsPerPage}
                                blogs={blogs}
